...
SQLite is one of four SQL backends selected the same way — by the
connection URI. **PostgreSQL**, **MariaDB / MySQL** and any
**ODBC**-reachable engine are also supported behind the ACE ABI:
