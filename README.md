...
- **109 doctest cases / 776 assertions passing** on Windows / MSVC 2022 Release.
- **~72 ACE entry points wired** (read / write / lock / index / scope / memo / encryption / autoinc / transaction / savepoint).
- **Persistent WAL with crash recovery** is byte-identical for OpenADS-produced files.
- **Live tags:** `m0-done`, `m1-done`, `m2-done`, `m3-done`, `m3.5-done`, `m3.6-partial`, `m3.7-partial`, `m4-partial`, `m5-partial`, `m5.1-partial`, `m5.2-partial`, `m5.3-partial`.
